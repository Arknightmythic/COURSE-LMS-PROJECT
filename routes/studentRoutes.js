...
import { deleteStudent, getCourseStudent, getDetailStudents, getStudents, postStudents, updateStudents } from "../controller/StudentController.js";
...
studentRoutes.get("/student-courses", verifyToken, getCourseStudent)
